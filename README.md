...
- [benchmark_nvim](./benchmark_nvim.zsh):
  crude script for measuring Neovim's startup time; uses Zsh for FPA

- [foot_follow_system_theme](./foot_follow_system_theme.sh):
  makes [foot](https://codeberg.org/dnkl/foot) follow global theme's day/night cycle

- [lwpe-helper](./lwpe-helper.sh):
